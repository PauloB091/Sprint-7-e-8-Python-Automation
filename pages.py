...
class UrbanRoutesPage:
    ...
    supportive_plan_card = (By.XPATH, '//img[@alt="Comfort"]')
    active_plan_card = (By.XPATH, '//div[@class="tcard active"]//div[@class="tcard-title"]')
    phone_number_control = (By.XPATH,"//div[@class='np-button'][contains(., 'Número de telefone')]")
    ...
    card_code_input = (By.XPATH, "//input[@id='code']")
    ...
    def set_card(self, card_number, code):
        self._wait_for_element_to_be_clickable(self.payment_method_select).click()
        self._wait_for_visible(self.add_card_control).click()
        self._wait_for_visible(self.card_number_input).send_keys(card_number + Keys.TAB + code)
        self._wait_for_visible(self.card_plc_image).click()
        self._wait_for_visible(self.card_credentials_confirm_button).click()
